...
func Load() (*Config, error) {
	cfg := &Config{
		...
		Database: DatabaseConfig{
			Host:         getEnv("CART_SERVICE_DB_HOST", "localhost"),
			Port:         getEnv("CART_SERVICE_POSTGRES_PORT_INTERNAL", "5432"),
			User:         getEnv("CART_SERVICE_DB_USER", "postgres"),
			Password:     getEnv("CART_SERVICE_DB_PASSWORD", "toai20102002"),
			DBName:       getEnv("CART_SERVICE_DB_NAME", "cart_service_go_shop_db"),
