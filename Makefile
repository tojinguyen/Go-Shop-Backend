...
# Lệnh để seed 5,000,000 products
.PHONY: seed-products
seed-products:
	@echo "Seeding product-service database with 5000000 products..."
	@cd internal/services/product-service && go run ./cmd/seeder/main.go -products=5000000
